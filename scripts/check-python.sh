...
elif [ -x /Users/hukefan/.pyenv/versions/3.13.12/bin/python3.13 ] && /Users/hukefan/.pyenv/versions/3.13.12/bin/python3.13 -m maturin --version >/dev/null 2>&1; then
  python_bin=/Users/hukefan/.pyenv/versions/3.13.12/bin/python3.13
else
